...
<html>
    <head>
        <title>Đăng nhập</title>
          ...
          .banner-text p{color:#000; font-size: 18px;}
          </style>
    </head>
<body>
<form method="POST">
<section class="login-block">
  ...
  <div class="form-group">
    ...
    <input type="text" name="ten_user" class="form-control" placeholder="">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="exampleInputEmail1" class="text-uppercase">Số CCCD</label>
    <input type="text" name="CCCD" class="form-control" placeholder="">
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" class="text-uppercase">SĐT</label>
    <input type="text" name="SĐT" class="form-control" placeholder="">
  ...
  <?php
    error_reporting(0);
    session_start();
    $id_user = $_POST["tendangnhap_user"];
  ...
  <?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $CCCD = $_POST["CCCD"];
      $SĐT = $_POST["SĐT"];
      if($tendangnhap_user=="" || $ten_user=="" || $pass_user=="" || $ten_user=="" || $diachi=="" || $CCCD=="" || $SĐT=="")
      {
        echo "<p style='color:red'>Hãy điền đầy đủ thông tin</p>";   
      }
      else{
        $sql = "insert into user (tendangnhap_user, ten_user, pass_user, diachi, CCCD, SĐT) values ('$tendangnhap_user','$ten_user','$pass_user', '$diachi', '$CCCD', '$SĐT')";
        if(mysqli_query($connect,$sql) == true){
          header("Location: login.php");
        }
        else{
          echo "<p style='color:red'>Không thể đăng kí!</p>";        }
      }
    }
    ?>
  
    <div class="form-check">
      <button type="submit" name="trove" class="btn btn-login float-left">Quay lại</button>
    <?php
    ...
    ?>
    <button type="submit" name="submit" class="btn btn-login float-right">Đăng kí</button>
  </div>
    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        <div class="banner-text">
            <h2>VIBRANT</h2>
            <p>VIBRANT Group là một tập đoàn đa quốc gia có trụ sở chính được đặt tại Hàn Quốc và Nhật Bản. VIBRANT do doanh nhân người Hàn Quốc Shin Kyuk-ho thành lập lần đầu tiên vào tháng 6 năm 1948 tại Tokyo. Từ Tokyo, VIBRANT mở rộng sang Hàn Quốc với việc thành lập của Lotte Confectionery tại Seoul vào ngày 3 tháng 4 năm 1967 và cuối cùng phát triển trở thành tập đoàn kinh doanh đa ngành có quy mô lớn thứ 5 của Hàn Quốc.</p>
        </div>  
  </div>
    </div>
